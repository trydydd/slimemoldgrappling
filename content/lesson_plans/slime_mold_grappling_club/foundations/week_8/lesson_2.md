...
---
{{% expand open=true title="**Game 2: Twisting Armlock Game 1**" %}}
...
---
{{% expand open=true title="**Game 3: Twisting Armlock Game 2**" %}}
...
---
{{% expand open=true title="**Game 4: Twisting Armlock Game 3**" %}}
...
---
{{% expand open=true title="**Game 5: Knee on Belly Game 1**" %}}
