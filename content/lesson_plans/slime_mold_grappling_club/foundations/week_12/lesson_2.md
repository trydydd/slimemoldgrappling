...
---
{{% expand open=true title="**Game 2: Head and Arm Game 1**" %}}
...
---
{{% expand open=true title="**Game 3: Head and Arm Game  2**" %}}
...
---
{{% expand open=true title="**Game 4: Head and Arm Game 3**" %}}
...
---
{{% expand open=true title="**Game 5: North-South Game 1**" %}}
