...
---
{{% expand open=true title="**Game 1: Standing**" %}}
...
---
{{% expand open=true title="**Game 2: engaged guard game 1**" %}}
...
---
{{% expand open=true title="**Game 3: engaged guard game 2**" %}}
...
---
{{% expand open=true title="**Game 4: Engaged Guard Game 3**" %}}
...
---
{{% expand open=true title="**Game 5: Scarf Hold**" %}}
