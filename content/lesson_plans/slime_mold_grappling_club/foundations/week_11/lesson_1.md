...
---
{{% expand open=true title="**Game 2: Front Headlock Game 1**" %}}
...
---
{{% expand open=true title="**Game 3: Front Headlock Game 2**" %}}
...
---
{{% expand open=true title="**Game 4: Front Headlock Game 3**" %}}
