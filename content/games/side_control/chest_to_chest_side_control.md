...
top_player:
  ...
  win_condition: Isolate and control one arm using a bent arm control (e.g., Kimura or Americana), with wrist control, bent elbow, and figure-four reinforcement.
bottom_player:
  label: Bottom Player
  ...
  win_condition: Escape to turtle, seated guard (hands/feet between players), or full guard (legs wrapped).
---
